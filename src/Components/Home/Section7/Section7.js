...
export default function Section7() {
  return (
    ...
    <div className="box secbox1">
        <img className='img-fluid' src="icons/burger (1).png" alt="" />
    ...
    <div className="box secbox2">
        <img className='img-fluid' src="icons/fast-food.png" alt="" />
    ...
    <div className="box secbox3">
        <img className='img-fluid' src="icons/pizza-slice.png" alt="" />
    ...
    <div className="box secbox4">
        <img className='img-fluid' src="icons/ice-cream.png" alt="" />
